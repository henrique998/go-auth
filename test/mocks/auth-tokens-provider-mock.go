...
// Source: internal/app/contracts/auth-tokens-provider.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/contracts/auth-tokens-provider.go -destination=test/mocks/auth-tokens-provider-mock.go -package=mocks
//
