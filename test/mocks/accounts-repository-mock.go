...
// Source: internal/app/contracts/accounts-repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/contracts/accounts-repository.go -destination=test/mocks/accounts-repository-mock.go -package=mocks
//
...
func (m *MockAccountsRepository) Create(a entities.Account) error {
	m.ctrl.T.Helper()
...
func (m *MockAccountsRepository) FindByEmail(email string) entities.Account {
	m.ctrl.T.Helper()
...
func (m *MockAccountsRepository) FindById(accountId string) entities.Account {
	m.ctrl.T.Helper()
...
func (m *MockAccountsRepository) Update(a entities.Account) error {
	m.ctrl.T.Helper()
