...
func (m *MockVerificationCodesRepository) Create(vc entities.VerificationCode) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", vc)
	ret0, _ := ret[0].(error)
	return ret0
}

// Create indicates an expected call of Create.
func (mr *MockVerificationCodesRepositoryMockRecorder) Create(vc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockVerificationCodesRepository)(nil).Create), vc)
}

// Delete mocks base method.
func (m *MockVerificationCodesRepository) Delete(codeId string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", codeId)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete.
func (mr *MockVerificationCodesRepositoryMockRecorder) Delete(codeId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockVerificationCodesRepository)(nil).Delete), codeId)
}
